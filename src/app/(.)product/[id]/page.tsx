...
const ProductDetailedPage = () => {
    ...
    return <Dialog open={isOpen} onClose={() => {
        ...
        <div className="fixed inset bg-black/30" aria-hidden='true' />
                        ...
                        <div className="flex gap-x-8 h-96">
                            ...
                            <div className="flex-1 flex flex-col">
                                        ...
                                        {product?.rating.rate && (
                                            <div className="flex items-center ml-2 mr-6">
                                                ...
                                                {Array.from({ length: 5 - Math.floor(product.rating.rate) }, (_, i) => (
                                                    <StarIconOutline key={i} className='h4 w-4 text-yellow-500' />
                                                ))}
                                            </div>
                                        )}
                                ...
                                <div className="space-y-3 text-sm">
                                    ...
                                    <button onClick={() => window.location.reload()} className='button w-full bg-transparent border-blue-600 hover:bg-blue-600 hover:text-white hover:border-transparent'>View full details</button>
                                </div>
                            </div>
                        </div>
                    )}
